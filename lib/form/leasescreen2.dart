...
class LesseeDetailsScreenState extends State<LesseeDetailsScreen> {
  static List<String> provinces = ['Province 1', 'Province 2', 'Province 3'];
  String? selectedProvince;

  static List<String> cities = ['City 1', 'City 2', 'City 3'];
  String? selectedCity;

  static List<String> barangays = ['Barangay 1', 'Barangay 2', 'Barangay 3'];
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: Theme.of(context)
                      .textTheme
                      .bodyText2
                      ?.copyWith(color: Color(0xff686868)),
                      ...
                      children: [
                        DropdownButtonFormField<String>(
                          ...
                          items: provinces
                              ...
                              .toList(),
                          onChanged: (item) =>
                              setState(() => selectedProvince = item),
                        ),
                      ],
                    ),
                  ),
